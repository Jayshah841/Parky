...
namespace ParkyWeb.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            User objUser = await _unitofWork.User.LoginAsync(SD.UserAPIPath + "authenticate/", obj);
        ...
        {
            bool result = await _unitofWork.User.RegisterAsync(SD.UserAPIPath + "register/", obj);
            if (result == false)
            {
                return View();
            }
